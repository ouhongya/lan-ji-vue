<template>
  <div>
    ...
    <el-dialog
      ...
      style="text-align: center;"
    >
      <el-form :model="tag" ref="tag" label-width="60px" style="margin:0% 14%">
        <el-form-item label="名称:" prop="name" :rules="[{ required: true, message: '名称不能为空'}]">
          <el-input v-model="tag.name" size="small" type="text" maxlength="10" show-word-limit placeholder="请输入标签名"/>
        </el-form-item>
      </el-form>
      <div>
    ...
    <el-dialog
      ...
      style="text-align: center;"
    >
      <el-form :model="tagEdit" ref="tagEdit" label-width="80px" style="margin:0% 14%">
        <el-form-item label="名称:" prop="name" :rules="[{ required: true, message: '名称不能为空'}]">
          <el-input v-model="tagEdit.name" size="small" placeholder="请输入标签名" type="text" maxlength="10"
                    show-word-limit/>
        </el-form-item>
      </el-form>
      <div>
        <el-button type="primary" size="small" round @click="editQX(`tagEdit`)">取消</el-button>
