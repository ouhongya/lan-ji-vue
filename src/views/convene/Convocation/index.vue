<template>
  <div>
    <el-card class="card-layout">
      <el-row :gutter="10">
        <el-col :span="10">
          <el-input style="width: 230px" type="text" maxlength="10" show-word-limit prefix-icon="el-icon-search"
    ...
    <el-card class="card-layout">
      <el-table
        ...
        <el-table-column
          ...
          label="所属展览">
          <template slot-scope="props">
            {{props.row.exhibitionName===null?'暂无':props.row.exhibitionName}}
          </template>
        </el-table-column>
        <el-table-column
          prop="authorName"
        ...
        <el-table-column
          ...
          <template slot-scope="props">
            ...
            <el-button type="primary" v-if="props.row.exhibitionId===null" disabled size="small" class="el-icon-view"
                       round @click="viewExhibition(props.row.exhibitionId)">查看展览
            </el-button>
            <el-button type="primary" v-if="props.row.exhibitionId!==null" size="small" class="el-icon-view" round
                       @click="viewExhibition(props.row.exhibitionId)">查看展览
            </el-button>
          </template>
        </el-table-column>
      </el-table>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="召集地址:">
              <div class="divBorder">
                {{convene.address===null?`暂无`:convene.address}}
              </div>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="费用:">
              <div class="divBorder">
                {{convene.expenses===`0`?'免费':convene.expenses+"/元"}}
              </div>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="展览地址:">
              <div class="divBorder">
                {{exhibition.address===''?'暂无':exhibition.address}}
              </div>
            </el-form-item>
          </el-col>
        </el-row>
